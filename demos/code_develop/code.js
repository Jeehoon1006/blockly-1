 ...
 * @private
 */
Code.TABS_ = ['blocks', 'javascript', 'php', 'python', 'dart', 'lua', 'xml','test'];
...
Code.tabClick = function(clickedName) {
  ...
  if (document.getElementById('tab_test').className == 'tabon') {
//    var xmlTextarea = document.getElementById('content_test');
//    var xmlText = xmlTextarea.value;
//    var xmlDom = null;
////    try {
////      xmlDom = Blockly.Xml.textToDom(xmlText);
...
//    var xmlTextarea = document.getElementById('content_test');
//    var pyText = Blockly.Python.workspaceToCode(Code.workspace);
//    xmlTextarea.value = pyText;
//    xmlTextarea.focus();
  }
};
...
Code.init = function() {
  ...
  Code.bindClick('runPyButton', Code.runPy);
 ...
 * Using skrulpt.  Catch infinite loops.
 */
Code.runPy = function() {
